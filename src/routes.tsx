    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: 'demands/calendar',
            element: <Suspense fallback={null}>{React.createElement(lazy(() => import('./pages/execution/DemandCalendar')))}</Suspense>,
            metadata: {
              label: '需求日历',
              icon: <ScheduleOutlined />,
              closable: true,
          ...
          {
            path: 'production-plans/calendar',
            element: <Suspense fallback={null}>{React.createElement(lazy(() => import('./pages/execution/ProductionPlanCalendar')))}</Suspense>,
            metadata: {
              label: '生产日历',
              icon: <ScheduleOutlined />,
              closable: true,
